...
class Connection(object):
    ...
    def __init__(
        self, context: Context, socket: socket.socket | None = ...
    ) -> None: ...
...
class Context(object):
    ...
    def set_verify(
        self,
        mode: int,
        callback: Callable[[Connection, X509, int, int, int], bool]
        | None = ...,
    ) -> None: ...
    ...
    def use_certificate_file(
        self, certfile: str | bytes, filetype: int = ...
    ) -> None: ...
    def use_certificate(self, cert: X509) -> None: ...
    def use_privatekey_file(
        self, keyfile: str | bytes, filetype: int | None = ...
    ) -> None: ...
    ...
    def set_alpn_select_callback(
        self, callback: Callable[[Connection, list[bytes]], bytes]
    ) -> None: ...
