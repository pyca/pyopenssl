...
class X509Req:
    ...
    def from_cryptography(
        cls, crypto_req: CertificateSigningRequest
    ) -> X509Req: ...
...
class CRL:
    ...
    @classmethod
    def from_cryptography(
        cls, crypto_crl: CertificateRevocationList
    ) -> CRL: ...
    def get_issuer(self) -> X509Name: ...
    ...
    def set_version(self, version: int) -> None: ...
    def sign(
        self, issuer_cert: X509, issuer_key: PKey, digest: bytes
    ) -> None: ...
...
class X509Store:
    ...
    def load_locations(
        self, cafile: Text | bytes, capath: Text | bytes | None = ...
    ) -> None: ...
...
def dump_privatekey(
    ...
    pkey: PKey,
    cipher: bytes | None = ...,
    passphrase: bytes | Callable[[], bytes] | None = ...,
) -> bytes: ...
def load_privatekey(
    type: int,
    buffer: Text | bytes,
...
def load_pkcs12(
    buffer: Text | bytes, passphrase: bytes | None = ...
) -> PKCS12: ...
def sign(pkey: PKey, data: Text | bytes, digest: Text | bytes) -> bytes: ...
def verify(
    cert: X509, signature: bytes, data: Text | bytes, digest: Text | bytes
) -> None: ...
