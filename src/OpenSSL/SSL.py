...
if hasattr(_lib, "X509_V_ERR_CERT_SIGNATURE_FAILURE"):
    __all__.append("X509VerificationErrors")

    class X509VerificationErrors:
        """
        Error codes for X509 verification, as returned by the underlying
        ``X509_STORE_CTX_get_error()`` function and passed by pyOpenSSL to
        ...
        UNABLE_TO_GET_ISSUER_CERT = _lib.X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT
        UNABLE_TO_GET_CRL = _lib.X509_V_ERR_UNABLE_TO_GET_CRL
        ...
        CERT_SIGNATURE_FAILURE = _lib.X509_V_ERR_CERT_SIGNATURE_FAILURE
        CRL_SIGNATURE_FAILURE = _lib.X509_V_ERR_CRL_SIGNATURE_FAILURE
        CERT_NOT_YET_VALID = _lib.X509_V_ERR_CERT_NOT_YET_VALID
        CERT_HAS_EXPIRED = _lib.X509_V_ERR_CERT_HAS_EXPIRED
        CRL_NOT_YET_VALID = _lib.X509_V_ERR_CRL_NOT_YET_VALID
        CRL_HAS_EXPIRED = _lib.X509_V_ERR_CRL_HAS_EXPIRED
        ...
        OUT_OF_MEM = _lib.X509_V_ERR_OUT_OF_MEM
        DEPTH_ZERO_SELF_SIGNED_CERT = (
            _lib.X509_V_ERR_DEPTH_ZERO_SELF_SIGNED_CERT
        )
        SELF_SIGNED_CERT_IN_CHAIN = _lib.X509_V_ERR_SELF_SIGNED_CERT_IN_CHAIN
        ...
        CERT_CHAIN_TOO_LONG = _lib.X509_V_ERR_CERT_CHAIN_TOO_LONG
        CERT_REVOKED = _lib.X509_V_ERR_CERT_REVOKED
        INVALID_CA = _lib.X509_V_ERR_INVALID_CA
        PATH_LENGTH_EXCEEDED = _lib.X509_V_ERR_PATH_LENGTH_EXCEEDED
        INVALID_PURPOSE = _lib.X509_V_ERR_INVALID_PURPOSE
        CERT_UNTRUSTED = _lib.X509_V_ERR_CERT_UNTRUSTED
        CERT_REJECTED = _lib.X509_V_ERR_CERT_REJECTED
        SUBJECT_ISSUER_MISMATCH = _lib.X509_V_ERR_SUBJECT_ISSUER_MISMATCH
        AKID_SKID_MISMATCH = _lib.X509_V_ERR_AKID_SKID_MISMATCH
        AKID_ISSUER_SERIAL_MISMATCH = (
            _lib.X509_V_ERR_AKID_ISSUER_SERIAL_MISMATCH
        )
        KEYUSAGE_NO_CERTSIGN = _lib.X509_V_ERR_KEYUSAGE_NO_CERTSIGN
        UNABLE_TO_GET_CRL_ISSUER = _lib.X509_V_ERR_UNABLE_TO_GET_CRL_ISSUER
        UNHANDLED_CRITICAL_EXTENSION = (
            _lib.X509_V_ERR_UNHANDLED_CRITICAL_EXTENSION
        )
        KEYUSAGE_NO_CRL_SIGN = _lib.X509_V_ERR_KEYUSAGE_NO_CRL_SIGN
        UNHANDLED_CRITICAL_CRL_EXTENSION = (
            _lib.X509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION
        )
        INVALID_NON_CA = _lib.X509_V_ERR_INVALID_NON_CA
        ...
        INVALID_EXTENSION = _lib.X509_V_ERR_INVALID_EXTENSION
        INVALID_POLICY_EXTENSION = _lib.X509_V_ERR_INVALID_POLICY_EXTENSION
        NO_EXPLICIT_POLICY = _lib.X509_V_ERR_NO_EXPLICIT_POLICY
        DIFFERENT_CRL_SCOPE = _lib.X509_V_ERR_DIFFERENT_CRL_SCOPE
        UNSUPPORTED_EXTENSION_FEATURE = (
            _lib.X509_V_ERR_UNSUPPORTED_EXTENSION_FEATURE
        )
        UNNESTED_RESOURCE = _lib.X509_V_ERR_UNNESTED_RESOURCE
        PERMITTED_VIOLATION = _lib.X509_V_ERR_PERMITTED_VIOLATION
        EXCLUDED_VIOLATION = _lib.X509_V_ERR_EXCLUDED_VIOLATION
        SUBTREE_MINMAX = _lib.X509_V_ERR_SUBTREE_MINMAX
        ...
        UNSUPPORTED_NAME_SYNTAX = _lib.X509_V_ERR_UNSUPPORTED_NAME_SYNTAX
        CRL_PATH_VALIDATION_ERROR = _lib.X509_V_ERR_CRL_PATH_VALIDATION_ERROR
        HOSTNAME_MISMATCH = _lib.X509_V_ERR_HOSTNAME_MISMATCH
        EMAIL_MISMATCH = _lib.X509_V_ERR_EMAIL_MISMATCH
        IP_ADDRESS_MISMATCH = _lib.X509_V_ERR_IP_ADDRESS_MISMATCH
        APPLICATION_VERIFICATION = _lib.X509_V_ERR_APPLICATION_VERIFICATION
